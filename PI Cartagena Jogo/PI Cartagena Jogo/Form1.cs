...
namespace PI_Cartagena_Jogo
{
    public partial class Form1 : Form
    {
        ...
        private void btnTabuleiro_Click(object sender, EventArgs e)//Akira
        {
            this.Close();
            tabuleiro = new Thread(abrirTabuleiro);
            tabuleiro.SetApartmentState(ApartmentState.STA);
            tabuleiro.Start();
        }

        private void abrirTabuleiro(object obj)//Akira
        {
